...
const Modals = () => {
    return (
        <>
            ...
            <PortfolioModal id="resurgence" title="Visitor Management System" image={game} content={
                <>
                    <i><b>Code Name: </b> Resurgence</i>
                    <br/>
            ...
            <PortfolioModal id="infinite" title="Novel Infinite" image={safe} content={
                <>
            ...
            <PortfolioModal id="portfolio-react" title="Portfolio Site" image={submarine} content={
                <>
                    The Site currently you are seeing, is my Portfolio site, also my first ReactJS project.
                </>
