    ...
    return (
        <section className="page-section mb-0">
            <div className="container">
                ...
                <div className="row">
                    <div className="col-lg-4 ms-auto"><p className="lead">My name is Sathiyaraman M and I'm a Computer
                        Science Engineering student. I'm from India, living in Chennai and currently pursuing Computer
